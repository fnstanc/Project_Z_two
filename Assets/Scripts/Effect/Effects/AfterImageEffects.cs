...
/// 残影特效  
/// </summary>  
public class AfterImageEffects : NormalEffect
{
    //开启残影  
    ...
    //残影的生存时间  
    public float _SurvivalTime = 0.5f;
    //生成残影的间隔时间  
    ...
    {
        base.refreshEffect();
        _SkinnedMeshRenderer = this.info.parent.GetComponentInChildren<SkinnedMeshRenderer>();
